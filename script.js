...
class MinesweeperGame {
    ...
    constructor(width, height, nMine) {
 ...
 */
function safeStringToNumber(input) {
 ...
 */
function generateGameBoardHTML(width, height, game) {
